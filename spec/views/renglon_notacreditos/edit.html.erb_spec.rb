...
describe "renglon_notacreditos/edit.html.erb" do
  before(:each) do
  ...
  it "renders the edit renglon_notacredito form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => renglon_notacreditos_path(@renglon_notacredito), :method => "post" do
