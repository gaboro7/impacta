...
describe "renglon_notadebitos/new.html.erb" do
  before(:each) do
    assign(:renglon_notadebito, stub_model(RenglonNotadebito,
      :notadedebito => nil,
      :factura => nil,
      :comentario => "MyString",
      :cantidad => 1,
  ...
  it "renders new renglon_notadebito form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => renglon_notadebitos_path, :method => "post" do
