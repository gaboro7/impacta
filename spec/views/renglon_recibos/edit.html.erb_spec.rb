...
describe "renglon_recibos/edit.html.erb" do
  before(:each) do
  ...
  it "renders the edit renglon_recibo form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => renglon_recibos_path(@renglon_recibo), :method => "post" do
